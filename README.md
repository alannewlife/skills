...
- 公众号文章写作、配图和 Markdown 展示发布（也可以用作长图和海报）
...
- `gbot-handdraw`
  - 提供 001–261 手绘风格编号画廊，可按编号和主题生成中英文生图提示词。
  - 内置压缩后的风格参考图；需要直接生图时，会根据模型能力决定使用风格名称、核心特征或编号参考图。
...
3. 把生成的 Markdown 文章交给 `gbot-markdown-poster` 打开，进行预览、排版和分享为海报和公众号。
