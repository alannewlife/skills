...
- **Simple-web mode** — default. Prefer a simple, robust stack similar to [this 32kw page](https://www.32kw.com/view/bec2ff0): one sans stack for the main layer, one serif stack only when needed for emphasis, and one system mono stack for meta labels. Avoid external font dependencies unless the user explicitly wants them.
...
- Default to the simple-web font mode unless the user asks otherwise
