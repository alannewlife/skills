...
**Vibe:** Technical, controlled, dense, product-system, presentation-first

**Layout:** Fixed `1920x1080` stage scaled as a whole into the viewport. Right-side nav pills, upper-left mono page anchors, lower-right page numbers, dark panel cards.

**Typography:**
- Display / Body: `Noto Sans SC` (700/800/900)
...
**Signature Elements:**
- cyan-to-blue edge rails on cards
- subtle system-grid background
- bright yellow summary emphasis
- fixed desktop layout with no exploratory restyling

**Use Case:**
- repeatable engineering explainers
- internal mechanism walkthroughs
- presentations that must reproduce the current `skills-tech-ppt-html/index.html` visual system

**Preset Files:**
- [presets/card-based/README.md](./presets/card-based/README.md)
- [presets/card-based/tokens.md](./presets/card-based/tokens.md)
- [presets/card-based/layout-rules.md](./presets/card-based/layout-rules.md)
- [presets/card-based/slide-archetypes.md](./presets/card-based/slide-archetypes.md)
